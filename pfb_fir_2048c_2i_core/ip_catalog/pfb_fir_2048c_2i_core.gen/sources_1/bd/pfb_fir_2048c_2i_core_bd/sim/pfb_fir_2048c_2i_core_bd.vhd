...
--Date        : Mon Aug  2 13:00:44 2021
--Host        : rtr-dev1 running 64-bit Ubuntu 18.04.4 LTS
--Command     : generate_target pfb_fir_2048c_2i_core_bd.bd
--Design      : pfb_fir_2048c_2i_core_bd
...
entity pfb_fir_2048c_2i_core_bd is
  port (
    clk : in STD_LOGIC;
  ...
  attribute CORE_GENERATION_INFO of pfb_fir_2048c_2i_core_bd : entity is "pfb_fir_2048c_2i_core_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=pfb_fir_2048c_2i_core_bd,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=1,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SYSGEN,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of pfb_fir_2048c_2i_core_bd : entity is "pfb_fir_2048c_2i_core_bd.hwdef";
end pfb_fir_2048c_2i_core_bd;

architecture STRUCTURE of pfb_fir_2048c_2i_core_bd is
  component pfb_fir_2048c_2i_core_bd_pfb_fir_2048c_2i_core_1_0 is
  port (
    pol_in : in STD_LOGIC_VECTOR ( 255 downto 0 );
    sync : in STD_LOGIC_VECTOR ( 31 downto 0 );
    clk : in STD_LOGIC;
  ...
  end component pfb_fir_2048c_2i_core_bd_pfb_fir_2048c_2i_core_1_0;
  signal clk_1 : STD_LOGIC;
  signal pfb_fir_2048c_2i_core_1_pol_out : STD_LOGIC_VECTOR ( 287 downto 0 );
  signal pfb_fir_2048c_2i_core_1_sync_out : STD_LOGIC_VECTOR ( 0 to 0 );
  signal pol_in_1 : STD_LOGIC_VECTOR ( 255 downto 0 );
  signal sync_1 : STD_LOGIC_VECTOR ( 31 downto 0 );
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of clk : signal is "xilinx.com:signal:clock:1.0 CLK.CLK CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN pfb_fir_2048c_2i_core_bd_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000";
...
begin
  ...
  pol_out(287 downto 0) <= pfb_fir_2048c_2i_core_1_pol_out(287 downto 0);
  sync_1(31 downto 0) <= sync(31 downto 0);
  sync_out(0) <= pfb_fir_2048c_2i_core_1_sync_out(0);
pfb_fir_2048c_2i_core_1: component pfb_fir_2048c_2i_core_bd_pfb_fir_2048c_2i_core_1_0
     port map (
      clk => clk_1,
