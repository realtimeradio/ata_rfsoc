...
begin
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_027c5e_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_fcf5ba_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_470b5d_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_6b5e3a_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
...
begin
  ...
  counter : entity xil_defaultlib.sysgen_counter_f6823d2bda 
  port map (
    clr => '0',
    clk => clk_net,
    ce => ce_net,
...
begin
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_fc352f_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_ce6d93_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_b25a5f_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_52e1e9_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
...
begin
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_9c0ecb_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_1e2fde_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_6d8053_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_792025_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
...
begin
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_33c2ab_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_7cde6b_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_8165e0_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_220b07_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
...
begin
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_42c212_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_96c9fb_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_4e1c3f_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_4d6db9_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
...
begin
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_d28ae8_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_858fb8_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_3fe583_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_a6c1cd_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
...
begin
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_23a9e3_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_1480db_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_ae17f6_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_fc104c_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
...
begin
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_544357_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_3f9641_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_ac7bad_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
  ...
  generic map (
    ...
    c_width => 18,
    latency => 3,
    mem_init_file => "xpm_001338_vivado.mem",
    mem_size => 9216,
    mem_type => "block",
    read_reset_val => "0"
  )
