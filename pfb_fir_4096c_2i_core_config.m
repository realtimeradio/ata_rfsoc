...
function pfb_fir_4096c_2i_core_config(this_block)
  ...
  this_block.setEntityName('pfb_fir_4096c_2i_core_ip_struct');
  ...
  this_block.addFile('pfb_fir_4096c_2i_core_ip_struct.vhd');
return;
