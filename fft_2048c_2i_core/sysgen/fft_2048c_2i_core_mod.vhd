...
entity fft_2048c_2i_core_stub is
  port (
...
end fft_2048c_2i_core_stub;
architecture structural of fft_2048c_2i_core_stub is 
begin
  sysgen_dut : entity xil_defaultlib.fft_2048c_2i_core_0 
  port map (
    pol_in => pol_in,
    shift => shift,
    sync => sync,
