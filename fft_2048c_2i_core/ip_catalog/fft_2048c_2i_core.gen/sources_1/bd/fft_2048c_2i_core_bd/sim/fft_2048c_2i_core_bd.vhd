...
--Date        : Mon Aug  2 13:44:35 2021
--Host        : rtr-dev1 running 64-bit Ubuntu 18.04.4 LTS
--Command     : generate_target fft_2048c_2i_core_bd.bd
--Design      : fft_2048c_2i_core_bd
...
entity fft_2048c_2i_core_bd is
  port (
    clk : in STD_LOGIC;
  ...
  attribute CORE_GENERATION_INFO of fft_2048c_2i_core_bd : entity is "fft_2048c_2i_core_bd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=fft_2048c_2i_core_bd,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=1,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SYSGEN,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of fft_2048c_2i_core_bd : entity is "fft_2048c_2i_core_bd.hwdef";
end fft_2048c_2i_core_bd;

architecture STRUCTURE of fft_2048c_2i_core_bd is
  component fft_2048c_2i_core_bd_fft_2048c_2i_core_1_0 is
  port (
    pol_in : in STD_LOGIC_VECTOR ( 287 downto 0 );
    shift : in STD_LOGIC_VECTOR ( 15 downto 0 );
    sync : in STD_LOGIC_VECTOR ( 31 downto 0 );
  ...
  end component fft_2048c_2i_core_bd_fft_2048c_2i_core_1_0;
  signal clk_1 : STD_LOGIC;
  signal fft_2048c_2i_core_1_overflow : STD_LOGIC_VECTOR ( 0 to 0 );
  signal fft_2048c_2i_core_1_pol_out : STD_LOGIC_VECTOR ( 351 downto 0 );
  signal fft_2048c_2i_core_1_sync_out : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN fft_2048c_2i_core_bd_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000";
...
begin
  clk_1 <= clk;
  overflow(0) <= fft_2048c_2i_core_1_overflow(0);
  pol_in_1(287 downto 0) <= pol_in(287 downto 0);
  pol_out(351 downto 0) <= fft_2048c_2i_core_1_pol_out(351 downto 0);
  shift_1(15 downto 0) <= shift(15 downto 0);
  sync_1(31 downto 0) <= sync(31 downto 0);
  sync_out(0) <= fft_2048c_2i_core_1_sync_out(0);
fft_2048c_2i_core_1: component fft_2048c_2i_core_bd_fft_2048c_2i_core_1_0
     port map (
      clk => clk_1,
      overflow(0) => fft_2048c_2i_core_1_overflow(0),
