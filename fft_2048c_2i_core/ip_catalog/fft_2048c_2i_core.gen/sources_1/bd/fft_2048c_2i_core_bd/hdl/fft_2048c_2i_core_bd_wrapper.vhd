...
--Command     : generate_target fft_2048c_2i_core_bd_wrapper.bd
--Design      : fft_2048c_2i_core_bd_wrapper
...
entity fft_2048c_2i_core_bd_wrapper is
  port (
    clk : in STD_LOGIC;
...
end fft_2048c_2i_core_bd_wrapper;

architecture STRUCTURE of fft_2048c_2i_core_bd_wrapper is
  component fft_2048c_2i_core_bd is
  port (
    clk : in STD_LOGIC;
    overflow : out STD_LOGIC_VECTOR ( 0 to 0 );
    pol_in : in STD_LOGIC_VECTOR ( 287 downto 0 );
  ...
  end component fft_2048c_2i_core_bd;
begin
fft_2048c_2i_core_bd_i: component fft_2048c_2i_core_bd
     port map (
      clk => clk,
