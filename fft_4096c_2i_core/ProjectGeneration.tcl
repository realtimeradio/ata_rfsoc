...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set ProjectFiles {
		...
		{{fft_4096c_2i_core_dist_mem_gen_i0_vivado.coe}}
		...
		{{xpm_c09f00_vivado.mem}}
		{{xpm_d99ed1_vivado.mem}}
		{{xpm_86a228_vivado.mem}}
		{{xpm_6e65db_vivado.mem}}
		{{xpm_68a1d7_vivado.mem}}
		{{xpm_07bcde_vivado.mem}}
		{{xpm_76197d_vivado.mem}}
		{{xpm_f5fed5_vivado.mem}}
		{{xpm_ecb464_vivado.mem}}
		{{fft_4096c_2i_core_entity_declarations.vhd} -lib {xil_defaultlib}}
		{{fft_4096c_2i_core.vhd} -lib {xil_defaultlib}}
		{{fft_4096c_2i_core_clock.xdc}}
		{{fft_4096c_2i_core.xdc}}
	}
	set SimPeriod 1
	set SimTime 6144
	set SimulationTime {24203.59900000 ns}
	set SynthStrategyName {Vivado Synthesis Defaults}
	set SynthesisTool {Vivado}
	set TargetDir {/home/jackh/src/ata_rfsoc/fft_4096c_2i_core}
	set TopLevelModule {fft_4096c_2i_core}
	set TopLevelSimulinkHandle 150523
	...
	dict set TopLevelPortInterface sync DatFile {fft_4096c_2i_core_sync.dat}
	...
	dict set TopLevelPortInterface sync ClockDomain {fft_4096c_2i_core}
	...
	dict set TopLevelPortInterface shift DatFile {fft_4096c_2i_core_shift.dat}
	...
	dict set TopLevelPortInterface shift ClockDomain {fft_4096c_2i_core}
	...
	dict set TopLevelPortInterface pol_in DatFile {fft_4096c_2i_core_pol_in.dat}
	...
	dict set TopLevelPortInterface pol_in ClockDomain {fft_4096c_2i_core}
	...
	dict set TopLevelPortInterface overflow DatFile {fft_4096c_2i_core_overflow.dat}
	...
	dict set TopLevelPortInterface overflow ClockDomain {fft_4096c_2i_core}
	...
	dict set TopLevelPortInterface pol_out Type UFix_352_0
	dict set TopLevelPortInterface pol_out ArithmeticType xlUnsigned
	dict set TopLevelPortInterface pol_out BinaryPoint 0
	dict set TopLevelPortInterface pol_out Width 352
	dict set TopLevelPortInterface pol_out DatFile {fft_4096c_2i_core_pol_out.dat}
	...
	dict set TopLevelPortInterface pol_out ClockDomain {fft_4096c_2i_core}
	...
	dict set TopLevelPortInterface sync_out DatFile {fft_4096c_2i_core_sync_out.dat}
	...
	dict set TopLevelPortInterface sync_out ClockDomain {fft_4096c_2i_core}
	...
	dict set TopLevelPortInterface clk ClockDomain {fft_4096c_2i_core}
