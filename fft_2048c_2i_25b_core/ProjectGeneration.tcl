...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set ProjectFiles {
		...
		{{fft_2048c_2i_25b_core_dist_mem_gen_i0_vivado.coe}}
		...
		{{fft_2048c_2i_25b_core_entity_declarations.vhd} -lib {xil_defaultlib}}
		{{fft_2048c_2i_25b_core.vhd} -lib {xil_defaultlib}}
		{{fft_2048c_2i_25b_core_clock.xdc}}
		{{fft_2048c_2i_25b_core.xdc}}
	}
	set SimPeriod 1
	set SimTime 6144
	...
	set TopLevelSimulinkHandle 420121
	...
	dict set TopLevelPortInterface sync DatFile {fft_2048c_2i_25b_core_sync.dat}
	...
	dict set TopLevelPortInterface sync ClockDomain {fft_2048c_2i_25b_core}
	...
	dict set TopLevelPortInterface shift DatFile {fft_2048c_2i_25b_core_shift.dat}
	...
	dict set TopLevelPortInterface shift ClockDomain {fft_2048c_2i_25b_core}
	...
	dict set TopLevelPortInterface pol_in DatFile {fft_2048c_2i_25b_core_pol_in.dat}
	...
	dict set TopLevelPortInterface pol_in ClockDomain {fft_2048c_2i_25b_core}
	...
	dict set TopLevelPortInterface overflow DatFile {fft_2048c_2i_25b_core_overflow.dat}
	...
	dict set TopLevelPortInterface overflow ClockDomain {fft_2048c_2i_25b_core}
	...
	dict set TopLevelPortInterface pol_out Type UFix_400_0
	dict set TopLevelPortInterface pol_out ArithmeticType xlUnsigned
	dict set TopLevelPortInterface pol_out BinaryPoint 0
	dict set TopLevelPortInterface pol_out Width 400
	dict set TopLevelPortInterface pol_out DatFile {fft_2048c_2i_25b_core_pol_out.dat}
	...
	dict set TopLevelPortInterface pol_out ClockDomain {fft_2048c_2i_25b_core}
	...
	dict set TopLevelPortInterface sync_out DatFile {fft_2048c_2i_25b_core_sync_out.dat}
	...
	dict set TopLevelPortInterface sync_out ClockDomain {fft_2048c_2i_25b_core}
	...
	dict set TopLevelPortInterface clk ClockDomain {fft_2048c_2i_25b_core}
