...
namespace eval ::xilinx::dsp::planaheaddriver {
	...
	set Project {int64_to_float32_latency4_core}
	set ProjectFiles {
		...
		{{vivado_ip.tcl}}
		{{int64_to_float32_latency4_core_entity_declarations.vhd} -lib {xil_defaultlib}}
		{{int64_to_float32_latency4_core.vhd} -lib {xil_defaultlib}}
		{{int64_to_float32_latency4_core_clock.xdc}}
		{{int64_to_float32_latency4_core.xdc}}
	}
	set SimPeriod 1
	set SimTime 10
	...
	set TargetDir {/home/jackh/src/ata_rfsoc/int64_to_float32_latency4_core}
	set TopLevelModule {int64_to_float32_latency4_core}
	set TopLevelSimulinkHandle 74190
	set VHDLLib {xil_defaultlib}
	set TopLevelPortInterface {}
	dict set TopLevelPortInterface din Name {din}
	dict set TopLevelPortInterface din Type Fix_64_0
	dict set TopLevelPortInterface din ArithmeticType xlSigned
	dict set TopLevelPortInterface din BinaryPoint 0
	dict set TopLevelPortInterface din Width 64
	dict set TopLevelPortInterface din DatFile {int64_to_float32_latency4_core_din.dat}
	...
	dict set TopLevelPortInterface din ClockDomain {int64_to_float32_latency4_core}
	...
	dict set TopLevelPortInterface dout DatFile {int64_to_float32_latency4_core_dout.dat}
	...
	dict set TopLevelPortInterface dout ClockDomain {int64_to_float32_latency4_core}
	...
	dict set TopLevelPortInterface clk ClockDomain {int64_to_float32_latency4_core}
